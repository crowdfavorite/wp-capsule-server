...
function capsule_server_admin_notice() {
	if ( empty( $_GET['page'] ) || false !== strpos( $_GET['page'], 'capsule' ) ) {
		return;
	}
?>
<section class="capsule-welcome">
	...
	<p>
		<?php
			...
			printf( esc_html__( 'Please read the overview, FAQs and more about <a href="%s">how Capsule Server works</a>.', 'capsule-server' ), esc_url( admin_url( 'admin.php?page=capsule' ) ) );
		?>
	</p>
</section>
<?php
