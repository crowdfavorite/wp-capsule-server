...
<table class="form-table">
	<tr>
		...
		<td><span class="description">
			<?php esc_html_e( 'To publish to this Capsule server, add the following information as a Server in your Capsule client.', 'capsule-server' ); ?>
		</td>
	</tr>
	...
	<tr>
		<th></th>
		<td><a href="<?php echo esc_url_raw( wp_nonce_url( admin_url( 'admin-ajax.php' ), 'cap-regenerate-key' ) ); ?>" id="cap-regenerate-key" class="button" data-user-id="<?php echo esc_attr( $user_data->ID ); ?>"><?php esc_html_e( 'Change Capsule API Key', 'capsule-server' ); ?></a></td>
	</tr>
</table>
</div>
